...
import { Search, Users, Package, ShoppingBag, Target, X, ArrowRight, Command } from "lucide-react";
...
function searchAll(query: string): Result[] {
  ...
  return [...clientes, ...pedidos, ...produtos, ...leads];
}
    ...
    <div className="relative hidden md:block">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-[280px] h-9 pl-9 pr-10 rounded-lg bg-background border border-border text-sm outline-none transition-all focus:border-ring focus:ring-2 focus:ring-ring/20 text-foreground placeholder:text-muted-foreground"
        />
            ...
            {results.length === 0 ? (
              ...
              <div className="py-2">
                ...
                <div className="border-t border-border px-3 py-2 flex items-center justify-between">
                  <p className="text-[10px] text-muted-foreground">{results.length} resultado{results.length !== 1 ? "s" : ""} encontrado{results.length !== 1 ? "s" : ""}</p>
